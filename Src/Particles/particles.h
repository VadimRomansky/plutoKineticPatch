...
/* *********************************************************************
  ...
  #define PARTICLES_KIN_SOLVER = GMRES
#endif
...
#endif
int     FindNumberToExchange(Data *, Grid *);
...
void    Particles_WriteBinary(Data* data, Grid* grid, double, Output *, char *);
void    Particles_WriteTab   (Data* data, Grid* grid, char filename[]);
void    Particles_WriteVTK   (Data* data, Grid* grid, Output *, char filename[]);
