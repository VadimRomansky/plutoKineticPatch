...
/* --------------------------------------------------------
   ...
   -------------------------------------------------------- */
    ...
    if (w == NULL) {
        w = ARRAY_BOX(-1, 1, -1, 1, -1, 1,
        double);
        emf0 = ARRAY_4D(3, NX3_TOT, NX2_TOT, NX1_TOT,
        double);

#if   ((PHYSICS == MHD) && (RESISTIVITY != NO)) \
 || (PHYSICS == ResRMHD)
        emf_res = ARRAY_4D(3, NX3_TOT, NX2_TOT, NX1_TOT,
        double);
#endif
    }
...
#if PARTICLES_CR_FEEDBACK == YES
    if (dM_tot == NULL) {
        dM_tot = ARRAY_4D(4, NX3_TOT, NX2_TOT, NX1_TOT,
        double);
        dM = ARRAY_4D(4, NX3_TOT, NX2_TOT, NX1_TOT,
        double);
        Fcr0 = ARRAY_4D(4, NX3_TOT, NX2_TOT, NX1_TOT,
        double);
    }
