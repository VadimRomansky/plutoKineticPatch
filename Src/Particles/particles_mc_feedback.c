...
/*! 
  \file  
  \brief File containing functions for feedback from MC to the fluid.
...
/* ********************************************************************* */
void Particles_MC_ConservativeFeedback(Data_Arr U, Data_Arr Fcr,
                                       double dt, RBox *box)
/*!
...
#endif  /* PARTICLES_MC_FEEDBACK == YES */
}

/* ********************************************************************* */
void Particles_MC_Flux(const State *state, int beg, int end)
/*!
 ...
 *********************************************************************** */
{
  ...
  DEBUG_FUNC_BEG ("Particles_MC_Flux");
  ...
  if (g_dir == IDIR){
    ...
    /* -- Clean parallel component (Fcr.B = 0) -- */
      ...
      inv_qg  = 1.0/(PARTICLES_MC_E_MC_GAS*v[RHO]);
  ...
  DEBUG_FUNC_END ("Particles_MC_Flux");
#endif
}

/* ********************************************************************* */
void Particles_MC_States1DCopy(const Data *d, const Sweep *sweep, int beg, int end)
/*!
 ...
 *********************************************************************** */
{
  ...
  DEBUG_FUNC_BEG ("Particles_MC_States1DCopy");
...
//stateR->Fcr[i-1][dir] = 0.5*(stateC->Fcr[i][dir] + stateC->Fcr[i-1][dir]);
  ...
  DEBUG_FUNC_END ("Particles_MC_States1DCopy");
#endif  /* PARTICLES_MC_FEEDBACK == YES */
}

/* ********************************************************************* */
void Particles_MC_StatesSource(const Sweep *sweep, double dt,
