...
*/
    ...
    strcpy(output->var_name[i++], "p");
    strcpy(output->var_name[i++], "F");
    strcpy(output->var_name[i++], "dV");
    strcpy(output->var_name[i++], "Einj");
...
/* --------------------------------------------------------
  ...
  #if (PARTICLES == PARTICLES_CR) || (PARTICLES == PARTICLES_MC) || (PARTICLES == PARTICLES_DUST)
