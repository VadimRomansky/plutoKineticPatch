...
/* ********************************************************************* */
void Particles_KIN_ComputeForce(Data_Arr V, const Data *data, Grid *grid)
/*!
 *
...
/* ********************************************************************* */
void Particles_KIN_ComputeCurrent(const Data *d, Grid *grid)
/*!
