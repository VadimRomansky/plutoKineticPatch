 ...
 *********************************************************************** */
{
  free ((char *)v);
  #if ARRAYS_DEBUG
  printf("array debug free array1d\n");
 ...
 *********************************************************************** */
{
  ...
  free ((char *) m);
  #if ARRAYS_DEBUG
  printf("array debug free array2d\n");
 ...
 *********************************************************************** */
{
  ...
  free ((char *) m);
  #if ARRAYS_DEBUG
  printf("array debug free array3d\n");
 ...
 *********************************************************************** */
{
  ...
  free ((char *) m);
  #if ARRAYS_DEBUG
  printf("array debug free array4d\n");
 ...
 *********************************************************************** */
{
  ...
  free((char *) (t+nrl));
  #if ARRAYS_DEBUG
  printf("array debug free arraybox\n");
 ...
 *********************************************************************** */
{
  ...
  free((char*) t);
  #if ARRAYS_DEBUG
  printf("array debug free array map\n");
...
/* -- allocate pointers to rows and set pointers to them -- */
  ...
  #if ARRAYS_DEBUG
  printf("array debug arraybox map\n");
 ...
 *********************************************************************** */
{
  ...
  free((char*) (t+nrl));
  #if ARRAYS_DEBUG
  printf("array debug free arraybox map\n");
