...
#ifdef NSAMPLING
extern double*** AL_Create_sampled_array(double*** , int);
//extern int AL_Fill_sampled_array(double*** , int);
//extern double*** AL_Get_sampled_array(double*** , int);
#endif
...
#ifdef NSAMPLING
extern int AL_Set_output_dim(int *sdims, int *sstart, int isz);
#endif
...
#ifdef NSAMPLING
extern int AL_Get_output_dim(int, int *);
extern int AL_Get_output_start(int, int *);
#endif
