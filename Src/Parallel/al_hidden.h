...
#ifdef NSAMPLING
  int samplingarrdim[AL_MAX_DIM]; /* global dimensions for output */
  int samplinglarrdim[AL_MAX_DIM]; /* local dimensions for output */
  int samplinggstart[AL_MAX_DIM]; /* starting global index for sampled output */
  int samplinglstart[AL_MAX_DIM]; /* starting local index for sampled output */
...
#ifdef NSAMPLING
  MPI_Datatype gsamplingsubarr; /* Global subarray for sparse MPI-IO */
  MPI_Datatype lsamplingsubarr; /* Local subarray for sparse MPI-IO */
