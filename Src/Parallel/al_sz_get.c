...
#ifdef NSAMPLING
/* ********************************************************************* */
int AL_Get_output_dim(int isz, int *ldims)
/*!
 * Get the local dimensions of a distributed array WITHOUT GHOST POINTS
 *
 * \param [in]  isz     Integer pointer to the input array descriptor
 ...
 *********************************************************************** */
{
  ...
  */
  ...
  ndim = s->ndim;
  for(i=0;i<ndim;i++){ ldims[i] = s->samplingarrdim[i];}

  return (int) AL_SUCCESS;
}

/* ********************************************************************* */
int AL_Get_output_start(int isz, int *sstart)
/*!
 * Get the local dimensions of a distributed array WITHOUT GHOST POINTS
 *
 * \param [in]  isz     Integer pointer to the input array descriptor
 ...
 *********************************************************************** */
{
  ...
  */
  ...
  ndim = s->ndim;
  for(i=0;i<ndim;i++){ sstart[i] = s->samplinggstart[i];}
